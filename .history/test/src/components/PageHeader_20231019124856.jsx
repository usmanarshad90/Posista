...
const PageHeader = () => {
  return (
    ...
    <Header style={{ display: 'flex', justifyContent: 'space-between' ,background-color: blue !important }}>
      <div className="logo" > 
      <Link to={'/'}><img src={logoimage} alt="" width="100px" /></Link>
        </div>
      <Menu  mode="horizontal" style={ {color:'black'}} >
      ...
      <div>
        <Button type="primary" style={{ marginRight: '10px' ,backgroundColor:'orange', }}>To Do L</Button>
