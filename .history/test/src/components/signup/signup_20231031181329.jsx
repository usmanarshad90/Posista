        ...
        <Col lg={{ span: 12, order: 1 }} md={24} xs={24}>
          <Card style={{ width: '100%', height: '96%' ,border:'none' }}>
            ...
            <Card style={{ textAlign: 'center' ,border:'none'}}>
              ...
              >
              <div>
              <p style={{paddingRight:'30vh'}}>Already have a Account? </p> <Link to="/login"><Button type="primary" style={{ marginRight: '5px', backgroundColor: 'orange' }}>Login</Button></Link></div>
                <Form.Item
