    ...
    <div >
      <Row gutter={[0, 0]}>
        <Col lg={{ span: 12, order: 1 }} md={24} xs={24}>
          <Card style={{ width: '100%', height: '96%' ,border:'none' }}>
            ...
            <Card style={{ textAlign: 'center' ,border:'none'}}>
              ...
              >
              <div>
              <p style={{paddingRight:'30vh'}}>Already have a Account? <Link to="/login"><Button type="primary" style={{ marginRight: '5px', backgroundColor: 'orange' }}>Login</Button></Link> </p></div>
                <Form.Item
        ...
        <Col lg={{ span: 12, order: 2 }} md={24} xs={24}>
          <Image width={'100%'} preview={false} height={'104.8%'} src={img} alt="#" />
        </Col>
      </Row>
    </div>
  );
