    ...
    <div >
      <Row gutter={[24, 24]}>
        <Col lg={{span: 12, order: 1 }} md={24} xs={24}>
          <Card style={{ width: '104%',height:'127.5%' }}>
            <Typography.Title style={{ textAlign: 'center' }}>ToDo List</Typography.Title>
            <Card style={{ textAlign: 'center', }} ><Form  layout="vertical" style={{ textAlign:'center',maxWidth: 400}}
              name="basic"
              initialValues={{
                remember: true,
        ...
        <Col lg={{ span: 12, order: 2 }} md={24} xs={24}>
          <Image width={'100%'} preview={false} height={'119%'} src={img} alt="#" />
        </Col>
      </Row>
    </div>
  );
