...
const Footer = () => {
  ...
  return (
    <Row><Col  lg={{ span:8, order: 1 }} md={6} xs={4} xl={8} xxl={8} style={style} >
      ...
      <Link to={'/pricing'} style={{color}}>Pricing</Link> </Typography.Title>
        
      <Typography.Title level={5}>
      <Link to={'/solution'} >Solutions</Link></Typography.Title> 
      <Typography.Title level={5}>
      <Link to={'/about'} >Categories</Link></Typography.Title>
      <Typography.Title level={5}>
      <Link to={'/about'} >About Us</Link></Typography.Title>
