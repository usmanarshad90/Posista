...
const Footer = () => {
  ...
  return (
    <Row><Col  lg={{ span:8, order: 1 }} md={6} xs={4} xl={8} xxl={8} style={sty}  >
      ...
      <div >Find us on: <FacebookOutlined  /> <InstagramOutlined /> <WhatsAppOutlined /></div>
      ...
      <Menu  mode="vertical" style={{textAlign:'start'}}  >
        <Link to={'/pricing'} ><Menu.Item key="1" >Pricing</Menu.Item></Link>
        
        
        <Link to={'/solution'} ><Menu.Item key="2" >Solutions</Menu.Item></Link>
        <Link to={'/about'} ><Menu.Item key="3" >Categori</Menu.Item></Link>
        <Link to={'/about'} ><Menu.Item key="4" >About Us</Menu.Item></Link>
      </Menu>
