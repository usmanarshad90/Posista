...
const Footer = () => {
  ...
  return (
    <Row><Col  lg={{ span:8, order: 1 }} md={6} xs={4} xl={8} xxl={8} style={style} >
      ...
      <Link to={'/pricing'} >Pricing</Link> <br /></Typography.Title>
        
      <Typography.Title level={5}>
      <Link to={'/solution'} >Solutions</Link><br /></Typography.Title> 
      <Typography.Title level={5}>
      <Link to={'/about'} >Categories</Link><br /></Typography.Title>
      <Typography.Title level={5}>
      <Link to={'/about'} >About Us</Link><br /></Typography.Title>
