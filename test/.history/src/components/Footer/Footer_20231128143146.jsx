...
const Footer = () => {
  ...
  return (
    <Row><Col  lg={{ span:8, order: 1 }} md={6} xs={4} xl={8} xxl={8} style={style} >
      ...
      <Typography.Title level={} >Navigation </Typography.Title>
     

      <div style={style}>
      <Link to={'/pricing'} style={style} >Pricing</Link> <br />
        
        
      <Link to={'/solution'}style={style} >Solutions</Link><br />
      <Link to={'/about'}style={style} >Categories</Link><br />
      <Link to={'/about'} style={style}>About Us</Link><br />
