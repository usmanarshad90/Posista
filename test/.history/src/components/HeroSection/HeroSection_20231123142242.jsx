...
const HeroSection = () => {
  ...
  return (
    <Row>
      <Col lg={{ span: 24, order: 1 }} md={24} xs={24} xl={24}></Col>
    <Col lg={{ span: 12, order: 2 }} md={8} xs={4} xl>
    ...
    <Col lg={{ span: 12, order: 3 }} md={24} xs={24}>
    <Image width={'80%'} preview={false} height={'90%'} src={image} alt="#" />
